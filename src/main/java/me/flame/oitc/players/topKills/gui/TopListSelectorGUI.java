...
public class TopListSelectorGUI {
    ...
    public Inventory topListSelectorGUI(User user){
        ...
        inventory.setItem(10, new ItemBuilder(Material.DIAMOND_SWORD, 1).setDisplayName("&aTop 5 Kills").build());

        inventory.setItem(12, new ItemBuilder(Material.BOOK, 1).setDisplayName("&aTop 5 Killstreak").build());

        inventory.setItem(14, new ItemBuilder(Material.SKELETON_SKULL, 1).setDisplayName("&aTop 5 Deaths").build());

        inventory.setItem(16, new ItemBuilder(Material.GOLD_INGOT, 1).setDisplayName("&aTop 5 Coins").build());
